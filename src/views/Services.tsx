...
const Services = () => {
  const servicesViewsData = [
    ...
    { description: "Digital & Social Media", image: "/img/icon_2.svg", id: "tercera_seccion" },
    { description: "Creativity and Content", image: "/img/icon_3.svg", id: "segunda_seccion" },
    { description: "Maling & Newsletters", image: "/img/icon_4.svg", id: "cuarta_seccion" },
    { description: "Photo Shoot", image: "/img/icon_5.svg", id: "quinta_seccion" },
    { description: "Audiovisual Production", image: "/img/icon_6.svg", id: "sexta_seccion" },
  ];
  return (
